    ...
    $args = [
        'body'    => $featured_image_url 
            ...
            : [
              ...
              'timeout' => 10, // Thay đổi thành 10 giây hoặc giá trị phù hợp
              'blocking' => false,
    ];
 ...
 * @param int $length Số lượng ký tự tối đa.
 * @param string $ellipsis Ký tự thêm vào cuối nếu chuỗi bị cắt.
 * @return string Chuỗi đã cắt.
 */
function telegram_notifier_trim_by_characters($text, $length, $ellipsis = '...') {
    if (mb_strlen($text, 'UTF-8') > $length) {
        // Đảm bảo đủ chỗ cho dấu ba chấm
